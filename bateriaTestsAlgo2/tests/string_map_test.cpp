...
TEST(string_map_test, test_insert){
	...
	EXPECT_TRUE(m.count("Filiberto"));
	EXPECT_FALSE(m.count("Filibertos"));
	EXPECT_FALSE(m.count("Robertos"));
	EXPECT_FALSE(m.count("Robert"));
	EXPECT_TRUE(m.count(""));
	EXPECT_FALSE(m.count("Waraberto"));
	EXPECT_FALSE(m.count("Robey Robert Roberto"));
}
