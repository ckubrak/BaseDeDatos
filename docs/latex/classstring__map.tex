...
\begin{DoxyCompactList}\small\item\em Limpia el mapa, lo deja solo con la raiz. \end{DoxyCompactList}\item 
...
\label{_amgrp804caec2222e5f28d512690182d357cf}%
 rep\+: \hyperlink{classstring__map}{string\+\_\+map} $\to$ bool~\newline
 rep(e) $\equiv$
\begin{DoxyItemize}
...
\item ( $\forall$ \hyperlink{structstring__map_1_1Nodo}{Nodo} n que pertenece al arbol) ( $\forall$ 0$<$=i$<$=95) n\mbox{[}i\mbox{]} $=_{\rm obs}$ N\+U\+L\+L $\Rightarrow$ n.\+sig != N\+U\+L\+L Aclaracion\+: suponemos que existe el T\+A\+D Char. La funcion int\+To\+Char recibe un int y devuelve un char correspondiente (con i= 0 retorna el carácter numero 32 de A\+S\+C\+I\+I, hasta el 95 que retorna el carácter 127). Decidimos describir algunas partes del Invariante de Representación en lenguaje natural ya que para poder utilizar Existenciales o Para Todos sobre los nodos ibamos a requerir funciones del lenguaje de especificación. El problema con esto es que, para poder utilizarlas con los nodos, tambien ibamos a requerir una funcion de Abstracción, un invariante de Representación y una especificacion de nuestro T\+A\+D \hyperlink{structstring__map_1_1Nodo}{Nodo}. Consideramos que esto escapaba a la consigna del trabajo Práctico. Nota\+: Puede pasar que significado y cs no esten sincronizados. Abs\+: \hyperlink{classstring__map}{string\+\_\+map} $\to$ Dicc(string,alfa) \{Rep(e)\}~\newline
 ( $\forall$ e\+:estr(alfa)) Abs(e) $=_{\rm obs}$ d\+: Dicc(string,alfa) $\vert$~\newline
 ( $\forall$ s\+: string) def?(s,d) $\equiv$ ((Existe un unico \hyperlink{structstring__map_1_1Nodo}{Nodo} n) n pertenece al string map $\land$ n.\+clave $=_{\rm obs}$ s $\land$ n-\/$>$significado != N\+U\+L\+L $\land$ ((n-\/$>$significado).valor) $=_{\rm obs}$ obtener(s,d) 
...
\item 
\hypertarget{classstring__map_a8e12bfe4444321c6147f3b7b20c68c05}{int {\bfseries char\+To\+Int} (char ch) const }\label{classstring__map_a8e12bfe4444321c6147f3b7b20c68c05}

\item 
\hypertarget{classstring__map_af0d19588b3448ed088725fb3163fc00b}{\hyperlink{classstring__map}{string\+\_\+map}$<$ T $>$\+::\hyperlink{structstring__map_1_1Nodo}{Nodo} $\ast$ {\bfseries buscar\+Nodo} (const key\+\_\+type \&key) const }\label{classstring__map_af0d19588b3448ed088725fb3163fc00b}

\item 
\hypertarget{classstring__map_aca26db2736ab8426cea28b96b6079994}{\hyperlink{classstring__map}{string\+\_\+map}$<$ T $>$\+::\hyperlink{structstring__map_1_1Nodo}{Nodo} $\ast$ {\bfseries minima\+Clave} (\hyperlink{structstring__map_1_1Nodo}{Nodo} $\ast$nodo) const }\label{classstring__map_aca26db2736ab8426cea28b96b6079994}

\item 
\hypertarget{classstring__map_a425afd1135cdb0109c5b44f5d0161479}{bool {\bfseries revisar\+Igualdad} (const \hyperlink{classstring__map}{string\+\_\+map}$<$ T $>$ \&b) const }\label{classstring__map_a425afd1135cdb0109c5b44f5d0161479}

\item 
\hypertarget{classstring__map_aec7806190feff7f4ff14679c92ae8cea}{void {\bfseries borrar\+Todo} (\hyperlink{structstring__map_1_1Nodo}{Nodo} $\ast$desde)}\label{classstring__map_aec7806190feff7f4ff14679c92ae8cea}

\item 
\hypertarget{classstring__map_a4b4ffdd6ad5ade098c3667ab3c80746b}{void {\bfseries copiar} (const \hyperlink{classstring__map}{string\+\_\+map}$<$ T $>$ \&a\+Copiar)}\label{classstring__map_a4b4ffdd6ad5ade098c3667ab3c80746b}

\item 
\hypertarget{classstring__map_a2bc06097a8b42763d4556450db59c4da}{void {\bfseries borrar\+Recursivo} (\hyperlink{structstring__map_1_1Nodo}{Nodo} $\ast$a\+Borrar)}\label{classstring__map_a2bc06097a8b42763d4556450db59c4da}

\item 
\hypertarget{classstring__map_ac6a88a22faefe94a12ad9f78c047203d}{int {\bfseries cant\+Hijos} (\hyperlink{structstring__map_1_1Nodo}{Nodo} $\ast$nodo)}\label{classstring__map_ac6a88a22faefe94a12ad9f78c047203d}
...
Limpia el mapa, lo deja solo con la raiz. 
...
\begin{DoxyDescription}
\item[Complejidad Temporal]//\+T\+O\+D\+O
...
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondición}
{\bfseries res} $=_{\rm obs}$ \&beta (def?(key,this0)) $\land$ if (def?(key,this0)) then (this $=_{\rm obs}$ borrar(key,this0)) else this $=_{\rm obs}$ this0) //\+T\+O\+D\+O arreglar ese if then else
\end{DoxyPostcond}
...
\end{DoxyPrecond}
\begin{DoxyPostcond}{Postcondición}
def?(pi1(t), this) $\land$ pi2(res) $=_{\rm obs}$ (N\+O(def?(pi1(t),this0))) y el pi1(res) es un iterador que apunta a la tupla parametro
\end{DoxyPostcond}
