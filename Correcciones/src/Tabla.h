...
public:
 ...
 private:
  ...
  // @corregir declarar friend a BaseDeDatos rompe excesivamente el encapsulamiento. Si necesitan acceder a algo privado de Tabla vean cómo modificar la interfaz pública de Tabla para que esto se pueda hacer de manera controlada.
